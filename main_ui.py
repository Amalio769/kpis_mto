...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_adherencia_mp = QtWidgets.QPushButton(self.tab_mp)
        self.pushButton_adherencia_mp.setGeometry(QtCore.QRect(20, 30, 361, 31))
        self.pushButton_adherencia_mp.setObjectName("pushButton_adherencia_mp")
        self.pushButton_ratio_mp_mc = QtWidgets.QPushButton(self.tab_mp)
        self.pushButton_ratio_mp_mc.setGeometry(QtCore.QRect(20, 80, 361, 31))
        self.pushButton_ratio_mp_mc.setObjectName("pushButton_ratio_mp_mc")
        self.tabWidget_principal.addTab(self.tab_mp, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_adherencia_mp.setText(_translate("MainWindow", "PushButton"))
        self.pushButton_ratio_mp_mc.setText(_translate("MainWindow", "PushButton"))
        self.tabWidget_principal.setTabText(self.tabWidget_principal.indexOf(self.tab_mp), _translate("MainWindow", "Page"))

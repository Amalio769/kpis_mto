...
def kpi_adh_mto():
    ...
    df_hot_mp['kpi_adh_30'] = df_hot_mp[['tipo_exc', 'equipo', 'texto_breve']].apply(lambda x: get_kpi_adh(30, *x),
                                                                                     axis=1)
    df_hot_mp['kpi_adh_60'] = df_hot_mp[['tipo_exc', 'equipo', 'texto_breve']].apply(lambda x: get_kpi_adh(60, *x),
                                                                                     axis=1)
    df_hot_mp['kpi_adh_90'] = df_hot_mp[['tipo_exc', 'equipo', 'texto_breve']].apply(lambda x: get_kpi_adh(90, *x),
                                                                                     axis=1)
